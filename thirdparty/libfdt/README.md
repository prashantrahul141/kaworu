This is a copy of libfdt from U-Boot's source tree.

Readme of libfdt as it was on U-Boot source:
...
After importing, customizations were performed to be able to build and use
it within kaworu, See "git log" for details.
